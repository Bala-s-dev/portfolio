      ...
      >
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <div className="flex flex-col leading-none">
            <span className="font-black text-sm sm:text-base lg:text-lg tracking-tight uppercase">
              Bala.Sub
            </span>
            <span className="text-[7px] sm:text-[8px] font-black tracking-[0.3em] text-primary uppercase">
              v2025
            </span>
          </div>
        </Link>

        {/* ✅ Desktop Links (Appear Earlier + More Spacing) */}
        <div className="hidden md:flex items-center gap-8 lg:gap-12 text-[11px] font-black uppercase tracking-widest text-muted-foreground/80">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
        ...
        <div className="flex items-center gap-3">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
              side="right"
              className="bg-background/95 backdrop-blur-xl border-white/10 px-8 py-10"
            >
              ...
              <div className="flex flex-col gap-10 mt-20">
                ...
                <Link
                  href="#ai-lab"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center gap-3 text-2xl font-black uppercase tracking-tight text-primary"
                >
